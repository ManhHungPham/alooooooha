...
namespace qldoansvhutech.Controllers
{
    public class SinhVienController : Controller
    {
        ...
        public ActionResult Congviecduocgiao(Doan da)
        {
            Sinhvien sv = (Sinhvien)Session["Taikhoan"];
            da.Id_sv = sv.Id;
            var dsCongViec = db.Congviectuans.Where(n => n.Id_da == da.Id).ToList();
        ...
        public ActionResult TTGiangVien()
        {
            Sinhvien sv = (Sinhvien)Session["Taikhoan"];
            var GV = db.Gvhds.Where(n => n.Id == sv.Id_gv);
            return View(GV);
        }
    }
}