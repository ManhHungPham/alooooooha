...
namespace qldoansvhutech.Areas.Admin.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult SinhVien(int? page)
        {
            ...
            int pageSize = 7;
            return View(db.Sinhviens.ToList().OrderBy(n => n.STT).ToPagedList(pageNumber, pageSize));
        }
        ...
        {
            {
                int pageNumber = (page ?? 1);
                int pageSize = 7;
                return View(db.Doans.ToList().OrderBy(n => n.Id).ToPagedList(pageNumber, pageSize));
            }
        }
